...
**关键指令**：以下代码块中 `\x1b` 是 ASCII 27 号控制字符的文本表示。输出时**必须**将字面量 `\x1b` 替换为真正的 ESC 字符（byte 0x1B），终端才能渲染颜色。不要输出 `\x1b` 四个字符，要输出一个 ESC 字节。

```
\x1b[38;2;60;120;255m██████╗ ██╗███╗   ██╗ ██████╗  ██████╗ ██████╗ ██████╗ ███████╗  ███████╗██╗  ██╗██╗██╗     ██╗     \x1b[0m
\x1b[38;2;84;108;255m██╔══██╗██║████╗  ██║██╔════╝ ██╔════╝██╔═══██╗██╔══██╗██╔════╝  ██╔════╝██║ ██╔╝██║██║     ██║     \x1b[0m
\x1b[38;2;108;96;255m██████╔╝██║██╔██╗ ██║██║  ███╗██║     ██║   ██║██║  ██║█████╗    ███████╗█████╔╝ ██║██║     ██║     \x1b[0m
\x1b[38;2;132;84;255m██╔═══╝ ██║██║╚██╗██║██║   ██║██║     ██║   ██║██║  ██║██╔══╝    ╚════██║██╔═██╗ ██║██║     ██║     \x1b[0m
\x1b[38;2;156;72;255m██║     ██║██║ ╚████║╚██████╔╝╚██████╗╚██████╔╝██████╔╝███████╗  ███████║██║  ██╗██║███████╗███████╗\x1b[0m
\x1b[38;2;180;60;255m╚═╝     ╚═╝╚═╝  ╚═══╝ ╚═════╝  ╚═════╝ ╚═════╝ ╚═════╝╚══════╝  ╚══════╝╚═╝  ╚═╝╚═╝╚══════╝╚══════╝\x1b[0m
\x1b[90m                                                                                     by Shuor\x1b[0m
\x1b[33m╭─────────────────────────────── 售前演示环境搭建 v3.1 ───────────────────────────────╮\x1b[0m
\x1b[33m│\x1b[0m  🎯 流程   画像 → 调研 → 设计 → 搭建 → 质检 → 交付                                  \x1b[33m│\x1b[0m
\x1b[33m│\x1b[0m  📦 模块   项目管理 · 产品管理 · Wiki · 测试管理 · Ship                              \x1b[33m│\x1b[0m
\x1b[33m│\x1b[0m  🔧 通道   API 批量创建 + Web 独占操作（Puppeteer）                                  \x1b[33m│\x1b[0m
\x1b[33m│\x1b[0m  📋 触发   来活了，搭模板 [附表单] / 无表单→自动打开填写                             \x1b[33m│\x1b[0m
\x1b[33m╰──────────────────────────────────────────────────────────────────────────────────────╯\x1b[0m
```
